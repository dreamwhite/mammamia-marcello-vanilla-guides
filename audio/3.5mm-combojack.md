...
![Figure 1: dump from Clover](../.gitbook/assets/image%20%2829%29.png)

### Step 3: analyze codec dump

![Figure 2: Codec name Realtek ALC3254 aka ALC295](../.gitbook/assets/image%20%2852%29.png)

By scrolling the txt file you'll find something as depicted below

![Figure 3: Node 0x12 Pin Complex](../.gitbook/assets/image%20%2862%29.png)
...
![Figure 4: open ALCPlugFix.xcodeproj](../.gitbook/assets/image%20%2814%29.png)

![Figure 5: click on open](../.gitbook/assets/image%20%2843%29.png)

![Figure 6: open main.m](../.gitbook/assets/image%20%2851%29.png)
...
![Figure 7: Build project](../.gitbook/assets/image%20%2842%29.png)

![Figure 8: successfully build project](../.gitbook/assets/image%20%2840%29.png)

Then expand from left sidebar `Products` folder, right click on `ALCPlugFix` and click on `Show in Finder`.

![Figure 9: expand Products folder](../.gitbook/assets/image%20%2850%29.png)

![Figure 10: show in Finder ALCPlugFix exec](../.gitbook/assets/image%20%281%29.png)

![Figure 11: ALCPlugFix exec ](../.gitbook/assets/image%20%2834%29.png)

Replace `ALCPlugFix` in `alc_fix` folder with the one built before as depicted in `Figure 1` .

![Figure 12: alc\_fix folder](../.gitbook/assets/image%20%2816%29.png)

![Figure 13: replace file](../.gitbook/assets/image%20%2863%29.png)
...
![Figure 15: install daemon](../.gitbook/assets/image%20%2841%29.png)

...
![Status/Devices section](../.gitbook/assets/image%20%2858%29.png)

{% hint style="warning" %}
Please note that Hackintool suggest you some Layout IDs. In any case check the official AppleALC page for all layout ids
{% endhint %}

![Audio section](../.gitbook/assets/image%20%2829%29.png)

### Layout ID

![e.g. ALC295 layout ids](../.gitbook/assets/image%20%2826%29.png)
...
![Step 2: kext installation](../.gitbook/assets/image%20%2847%29.png)

### Get PCIRoot address using gfxutil

![...and drag the executable &quot;gfxutil&quot; inside the terminal window and type &quot;-f HDEF&quot; ](../.gitbook/assets/image%20%2846%29.png)
...
![Mount EFI and open config.plist](../.gitbook/assets/image%20%2824%29.png)

![Set Audio/Inject to No and change 77 with your layout-id](../.gitbook/assets/image%20%2827%29.png)
...
![System Preferences, Sound and check Output section](../.gitbook/assets/image%20%2849%29.png)

...
![Port Limit Patch for macOS 10.15.x](../../.gitbook/assets/image%20%28129%29.png)
...
![In this case USBInjectAll kext is not loaded so isn&apos;t in kextcache](../../.gitbook/assets/image%20%28131%29.png)
...
![\\_SB.PCI0.XHC.RHUB.HS01](../../.gitbook/assets/image%20%2867%29.png)
...
![&quot;xh\_OEMBD&quot; is the TableId](../../.gitbook/assets/image%20%2821%29.png)

After identifying the TableId of the SSDT that must be dropped add it inside `config.plist` 

![Clover Configurator](../../.gitbook/assets/image%20%2817%29.png)
...
![e.g. SS01 is unused therefore remove the external reference](../../.gitbook/assets/image%20%2884%29.png)
...
![GUPC method which sets connector type as internal](../../.gitbook/assets/image%20%2839%29.png)

![S3BP which sets connector type to USB3 B Powered](../../.gitbook/assets/image%20%28135%29.png)
...
![Mapped USB ports](../../.gitbook/assets/image%20%2859%29.png)
